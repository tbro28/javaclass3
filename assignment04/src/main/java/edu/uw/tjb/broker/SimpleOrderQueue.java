...
public final class SimpleOrderQueue<T, E extends Order>
   ...
   public final T getThreshold() {
    ...
    public void run() {
        ...
        /*
        From the solution review two locks were used.
        A queue lock and a "processor" lock.
        So queuing and processing the queued items is separate.
        The solution seems neat, but there is really no way I could have completed it on my own.
        */
