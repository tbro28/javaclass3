 ...
 * @author Russ Moul
 */
public final class SimpleAccountOriginal implements Account {

    /** Version id */
    private static final long serialVersionUID = 9028406835809215441L;

    /** The logger to be used by this class */
    private static final Logger logger = LoggerFactory.getLogger(SimpleAccountOriginal.class);
     ...
     *                          too low
     */
    public SimpleAccountOriginal(final String acctName, final byte[] passwordHash,
                                 final int balance)
