...
public class Running {
    ...
    public static void main(String args[]) throws DaoFactoryException, AccountException {
        ...
        Account tim = accountManager.createAccount("TimAccount", "16363638", 100000);

        try {
            Account tim2 = accountManager.createAccount("TimAccount", "16363638", 100000);
        } catch (AccountException e) {
            System.out.println("Caught dupe account.");
        }

        accountManager.persist(tim);
